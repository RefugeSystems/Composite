...
var topLevelKeys = [
	...
	"target",
	/**
	 * In cases where the source ID is not known, this field specifies the name of
	 * the source resource to find.
	 * @property sourceName
	 * @type String
	 */
	"sourceName",
	/**
	 * In cases where the target ID is not known, this field specifies the name of
	 * the target resource to find.
	 * @property targetName
	 * @type String
	 */
	"targetName",
